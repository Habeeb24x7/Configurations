...
/opt/solr_install/example/scripts/cloud-scripts/zkcli.sh -zkhost 172.31.3.111:2181,172.31.3.112:2181,172.31.3.113:2181 -cmd upconfig -confdir /opt/solr_home/collection1/conf -confname myconfig
sleep 20s
